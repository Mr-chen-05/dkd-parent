...
public class ChannelController extends BaseController
{
    ...
    public AjaxResult getGoodsList(@PathVariable String innerCode)
    {
        return success(channelService.selectChannelListByInnerCode(innerCode));
    }
    ...
    @Log(title = "售货机货道", businessType = BusinessType.UPDATE)
    @PutMapping("/config")
    public AjaxResult channelConfig(@RequestBody ChannelConfigDto channelConfigDto)
    {
        return toAjax(channelService.updateChannelConfig(channelConfigDto));
    }
