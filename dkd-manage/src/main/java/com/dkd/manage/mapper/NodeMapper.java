...
public interface NodeMapper
{
    ...
    List<Node> selectNodeByRegionId(@Param("ids") Long[] ids);

    List<Node> selectNodeByPartnerId(@Param("ids") Long[] ids);

    List<NodeVo> selectMachineByNodeId(@Param("id") Long id);

    List<Node> selectBatchNodeById(@Param("ids") Long[] ids);
}
