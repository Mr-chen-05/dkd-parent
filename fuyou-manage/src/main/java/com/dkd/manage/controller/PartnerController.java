...
public class PartnerController extends BaseController
{
    ...
    {
        startPage();
        List<PartnerVo> partnerListVo = partnerService.selectPartnerListVo(partner);
        return getDataTable(partnerListVo);
    }
    ...
    {
        return toAjax(partnerService.resetPwdPartner(id));
    }
