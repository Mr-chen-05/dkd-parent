...
public class Channel extends BaseEntity
{
    ...
    /** 货道编号（如 1-1, 2-3） */
    @Excel(name = "货道编号", readConverterExp = "如=,1=-1,,2=-3")
    ...
    /** 售货机ID（逻辑外键，关联 tb_vending_machine.id） */
    @Excel(name = "售货机ID", readConverterExp = "逻=辑外键，关联,t=b_vending_machine.id")
    private Long vmId;

    /** 售货机软编号（冗余，便于按机器查询） */
    @Excel(name = "售货机软编号", readConverterExp = "冗=余，便于按机器查询")
